 ...
 */
export function enumToSortedList<T extends EnumRecord>(
  enumObj: T,
): T[keyof T][] {
...
export const GENDER_CODES = Object.keys(Gender) as [
  GenderCode,
  ...GenderCode[],
];
...
export const WORK_STATUS_CODES = Object.keys(WorkStatus) as [
  WorkStatusCode,
  ...WorkStatusCode[],
];
...
export const CONTRACT_STATUS_CODES = Object.keys(ContractStatus) as [
  ContractStatusCode,
  ...ContractStatusCode[],
];
...
export const ORG_UNIT_TYPE_CODES = Object.keys(OrgUnitType) as [
  OrgUnitTypeCode,
  ...OrgUnitTypeCode[],
];
...
export const ORG_UNIT_STATUS_CODES = Object.keys(OrgUnitStatus) as [
  OrgUnitStatusCode,
  ...OrgUnitStatusCode[],
];
...
export const ORG_EVENT_TYPE_CODES = Object.keys(OrgEventType) as [
  OrgEventTypeCode,
  ...OrgEventTypeCode[],
];
...
export const ORG_EVENT_REASON_CODES = Object.keys(OrgEventReason) as [
  OrgEventReasonCode,
  ...OrgEventReasonCode[],
];
...
export const FAMILY_RELATION_CODES = Object.keys(FamilyRelation) as [
  FamilyRelationCode,
  ...FamilyRelationCode[],
];
...
export const PARTY_ORG_TYPE_CODES = Object.keys(PartyOrgType) as [
  PartyOrgTypeCode,
  ...PartyOrgTypeCode[],
];
...
export const EVAL_TYPE_CODES = Object.keys(EvalType) as [
  EvalTypeCode,
  ...EvalTypeCode[],
];
...
export const ASSIGNMENT_EVENT_TYPE_CODES = Object.keys(AssignmentEventType) as [
  AssignmentEventTypeCode,
  ...AssignmentEventTypeCode[],
];
...
export const TRAINING_LEVEL_CODES = Object.keys(TrainingLevel) as [
  TrainingLevelCode,
  ...TrainingLevelCode[],
];
...
export const ACADEMIC_TITLE_CODES = Object.keys(AcademicTitle) as [
  AcademicTitleCode,
  ...AcademicTitleCode[],
];
...
export const CONTRACT_DOC_STATUS_CODES = Object.keys(ContractDocStatus) as [
  ContractDocStatusCode,
  ...ContractDocStatusCode[],
];
...
export const TRAINING_STATUS_CODES = Object.keys(TrainingStatus) as [
  TrainingStatusCode,
  ...TrainingStatusCode[],
];
...
export const PARTICIPATION_STATUS_CODES = Object.keys(ParticipationStatus) as [
...
export const RESULT_STATUS_CODES = Object.keys(ResultStatus) as [
  ResultStatusCode,
  ...ResultStatusCode[],
];
...
export const CATALOG_STATUS_CODES = Object.keys(CatalogStatus) as [
  CatalogStatusCode,
  ...CatalogStatusCode[],
];
...
export const Role = {
  ...
  EMPLOYEE: { code: "EMPLOYEE", label: "Cán bộ", sortOrder: 4 },
} as const;
