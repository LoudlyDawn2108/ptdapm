...
export type CreateAllowanceTypeInput = z.infer<
    typeof createAllowanceTypeSchema
>;

export const updateAllowanceTypeSchema = createAllowanceTypeSchema
    .partial()
    .extend({
        status: catalogStatusSchema.optional(),
    });

export type UpdateAllowanceTypeInput = z.infer<
    typeof updateAllowanceTypeSchema
>;
...
export type CreateSalaryGradeStepInput = z.infer<
    typeof createSalaryGradeStepSchema
>;

export const updateSalaryGradeStepSchema = createSalaryGradeStepSchema
    .partial()
    .extend({
        status: catalogStatusSchema.optional(),
    });

export type UpdateSalaryGradeStepInput = z.infer<
    typeof updateSalaryGradeStepSchema
>;
...
export type CreateTrainingCourseTypeInput = z.infer<
    typeof createTrainingCourseTypeSchema
>;

export const updateTrainingCourseTypeSchema = createTrainingCourseTypeSchema
    .partial()
    .extend({
        status: catalogStatusSchema.optional(),
    });

export type UpdateTrainingCourseTypeInput = z.infer<
    typeof updateTrainingCourseTypeSchema
>;
