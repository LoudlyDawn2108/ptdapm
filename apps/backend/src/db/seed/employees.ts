...
async function seedEmployees() {
  ...
  const bankData = [
    ...
    { employeeIdx: 0, bankName: "Vietcombank", accountNo: "00112233445566", isPrimary: false },
