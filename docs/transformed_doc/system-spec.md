...
| **STRQ 10:** Phòng tài chính muốn thống kê chi tiết về nhân sự. | * Thêm các chi tiết | * **FEAT 10.1:** Hệ thống cho phép phòng nhân sự và phòng tài chính xem và xuất các thống kê nhân sự thông qua giao diện dashboard hoặc báo cáo tổng hợp: thống kê tổng quan nhân sự, biến động nhân sự, cơ cấu nhân sự theo đơn vị, cơ cấu nhân sự theo trình cơ cấu nhân sự theo trình độ, học hàm, chức danh, độ, học hàm, chức danh, đánh giá của cán bộ với khóa đào tạo, hợp đồng, báo cáo bổ nhiệm nhân sự, báo cáo bổ nhiệm nhân sự. |
...
| Luồng sự kiện thay thế  (Alternative Flow) | Không có |
| Luồng sự kiện ngoại lệ  (Exception Flow) | **E1: Không được phép chỉnh sửa do trạng thái khóa đào tạo**   1. Tại bước 7, hệ thống phát hiện nếu khóa đào tạo ở trạng thái “Đã bắt đầu đào tạo” hoặc “Đã kết thúc”. 2. Hệ thống hiển thị thông báo từ chối chỉnh sửa.   **E2: Vi phạm ràng buộc đăng ký**   1. Tại bước 7, hệ thống phát hiện nếu: Giảm giới hạn số người tham gia nhỏ hơn số lượng đã đăng ký. 2. Hệ thống hiển thị cảnh báo và không cho phép lưu.   **E3: Dữ liệu không hợp lệ**   1. Tại bước 7, hệ thống phát hiện thiếu trường bắt buộc hoặc thời gian không hợp lệ. 2. Hệ thống yêu cầu chỉnh sửa lại thông tin.   **E4: Hủy thao tác**   1. Tại bước 5, Phòng TCCB chọn “Hủy”. 2. Quay lại màn hình danh sách nhân sự. |
