...
| Luồng sự kiện ngoại lệ (Exception Flow) | **E1: Sai thông tin trường dữ liệu** 1\.  Tại bước 7, hệ thống phát hiện các lỗi tại các trường thông tin 2\.  Hệ thống thông báo lỗi 3\. Hệ thống từ chối lưu dữ liệu. **E2: Hủy thao tác** Tại bước 2, người dùng nhấn “Hủy” Hệ thống quay lại màn hình chính. |
...
| Luồng sự kiện thay thế (Alternative Flow) | Không có |
| Luồng sự kiện ngoại lệ (Exception Flow) | **E1: Dữ liệu lưu không hợp lệ** Tại bước 6, Hệ thống validate phát hiện các trường thông tin không hợp lệ. Hệ thống thông báo lỗi tương ứng Dữ liệu không được lưu **E2: Admin hủy thao tác** Tại bước 2, Admin nhấn “Hủy” Hệ thống quay lại màn hình danh sách người dùng |
...
| Luồng sự kiện chính (Basic Flow) | Hệ thống hiển thị sơ đồ cây cơ cấu tổ chức hiện tại. Người dùng chọn một đơn vị đang ở trạng thái "Đang hoạt động". Người dùng chọn chức năng "Cập nhật trạng thái đơn vị". Hệ thống hiển thị form cập nhật, đồng thời **hiển thị cảnh báo danh sách các đơn vị con trực thuộc** (nếu có). Người dùng chọn loại sự kiện: **Giải thể**. Người dùng nhập các thông tin bắt buộc: Ngày hiệu lực (ngày giải thể). Quyết định (Số quyết định, Ngày quyết định, File đính kèm). Lý do (Giải thể / Tái cơ cấu / Khác). **Xử lý đơn vị con (Nếu có):** Người dùng chọn phương án xử lý cho các đơn vị trực thuộc: *Tùy chọn A:* Giải thể toàn bộ đơn vị con. *Tùy chọn B:* Điều chuyển đơn vị con sang trực thuộc một đơn vị cha khác (yêu cầu chọn đơn vị cha mới từ danh sách). Người dùng nhấn nút **"Lưu xác nhận"**. Hệ thống kiểm tra tính hợp lệ của dữ liệu đầu vào. Hệ thống thực hiện cập nhật đồng loạt: Cập nhật trạng thái đơn vị đang thao tác từ “Đang hoạt động” → **“Giải thể”**. **Đối với đơn vị con:** Thực hiện Giải thể hoặc Cập nhật đơn vị quản lý cấp trên mới tùy theo lựa chọn tại Bước 7\. **Đối với nhân sự:** Tất cả hợp đồng đang hiệu lực → "Hết hiệu lực". Trạng thái hợp đồng của nhân sự → "Chưa hợp đồng". Trạng thái làm việc của nhân sự → "Đang chờ xét". Xóa thông tin đơn vị công tác hiện tại của các nhân sự thuộc đơn vị bị giải thể. Hệ thống lưu lịch sử thay đổi và hiển thị thông báo "Cập nhật thành công".  |
...
| Điều kiện tiên quyết (Precondition) | Trạng thái của nhân sự được cập nhật thành 'Thôi việc' trong hồ sơ nhân sự thành công  |
...
| Luồng sự kiện ngoại lệ (Exception Flow) | **E1: Nhân sự đã ở trạng thái "Đã thôi việc"** Tại bước 1, hệ thống phát hiện nhân sự đã có trạng thái làm việc "Đã thôi việc". Hệ thống vô hiệu hóa nút "Đánh dấu thôi việc" hoặc hiển thị cảnh báo: *"Nhân sự này đã được đánh dấu thôi việc trước đó."* **E2: Nhân sự chưa thanh lý hợp đồng hoặc chưa bãi nhiệm chức vụ** Tại bước hệ thống kiểm tra dữ liệu, phát hiện nhân sự vẫn còn Hợp đồng lao động đang ở trạng thái "Có hiệu lực" hoặc đang giữ chức vụ quản lý (Trưởng khoa, Trưởng bộ môn...). Hệ thống chặn thao tác lưu và thông báo: *"Vui lòng thanh lý hợp đồng và bãi nhiệm chức vụ của nhân sự trước khi đánh dấu thôi việc."* **E3: Hủy thao tác** Tại bước 2, Phòng TCCB chọn "Hủy". Hệ thống quay lại màn hình danh sách nhân sự. |
...
| Điều kiện tiên quyết (Precondition) | Cán bộ Phòng TCCB đã đăng nhập hệ thống. Khóa đào tạo đã tồn tại trong hệ thống. Khóa đào tạo đang ở trạng thái “Mở đăng ký”. |
...
| Luồng sự kiện chính (Basic Flow) | 1\. Cán bộ/Giảng viên truy cập menu “Đào tạo”. 2\. Hệ thống hiển thị danh sách các khóa đào tạo đang Mở đăng ký. 3\. Cán bộ/Giảng viên chọn một khóa đào tạo để xem chi tiết thông tin. 4\. Cán bộ/Giảng viên nhấn nút “Đăng ký tham gia”. 5\. Hệ thống kiểm tra các điều kiện đăng ký (thời gian, số lượng, trạng thái). 6\. Hệ thống ghi nhận đăng ký và thiết lập trạng thái khóa học đăng ký là “Đã đăng ký” tương ứng. 7\. Hệ thống thông báo đăng ký thành công cho Cán bộ/Giảng viên. |
| Luồng sự kiện thay thế (Alternative Flow) | Không có |
